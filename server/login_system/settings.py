...
SECRET_KEY = '-hmrk&(q5c(@#j6*=f3hglsnzs*y5sx7%&psh1((vdlbbybuj$'
...
STATIC_ROOT = '/var/www/html/login_system/public/static/'

MEDIA_ROOT = '/var/www/html/login_system/public/media/'
